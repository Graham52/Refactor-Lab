...
//    @Test
//    public void AddConferenceRoomToEventRoom() {
//        hotel.addEventRoom(conferenceRoom);
//        assertEquals(1, hotel.getNumberOfEventRooms());
//    }
...
//    }
    @Test
    public void AddADiningRoomToEventRoom(){
...
//    }
    ...
    public void canCheckGuestsIntoEventRoom() {
        hotel.addEventRoom(conferenceRoom);
        ArrayList<Guest> guestList = new ArrayList<Guest>();
        guestList.add(guest1);
        hotel.setEventRooms(conferenceRoom);
